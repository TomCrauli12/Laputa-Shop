        ...
        <div class="basket_card">
                    ...
                    <div class="info_product">
                        ...
                        <div class="button">
                            <?php if(isset($_SESSION['login'])): ?>
                                <div class="like">
                                    <a href="../scripts/PostController.php?action=AddToBasket&&product_id=<?=$key['id']?>"><img src="../image/Image_system/icons8-сердце-50 (2).png" alt="избранное"></a>
                                </div>
                                <div class="bascet">
                                    <a href="../scripts/PostController.php?action=deleteProduct&&id=<?=$basket_id?>">Удалить из корзины</a>
                                </div>
                            <?php else: ?>
